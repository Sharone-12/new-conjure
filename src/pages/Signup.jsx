  ...
  return (
    <>
      ...
      <div style={{
        ...
        {/* card */}
        <div className={`card${shaking ? " shake" : ""}`} style={{
          ...
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            }}>Start your AI-powered workspace</p>
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate
            ...
            <div>
              ...
              <input
                type="text"
                className={`field${fieldErrs.name ? " err" : ""}`}
            ...
            <div>
              ...
              <input
                type="email"
                className={`field${fieldErrs.email ? " err" : ""}`}
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  className={`field${fieldErrs.password ? " err" : ""}`}
                  placeholder="••••••••"
                  value={form.password}
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  className={`field${fieldErrs.confirm ? " err" : ""}`}
                  placeholder="••••••••"
                  value={form.confirm}
